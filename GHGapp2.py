...
if file1 is not None:
    ...
    fig4 = go.Figure(data=go.Scatter(x=df1['Month'], y=alltotalco2e/1000, name="Monthly GHG emission"))
    fig4.add_trace(go.Scatter(x=df1['Month'], y=avggraph/1000, name="Average GHG emission"))
